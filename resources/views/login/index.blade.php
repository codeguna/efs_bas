...
<head>
    ...
    <title>EFS BAS - LOGIN</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="shortcut icon" type="image/png" href="{{ asset('/theme/images/icon/favicon.ico') }}">
            ...
            <div class="login-box ptb--100">
				<form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="login-form-head">
                        <h4>Sign In</h4>
                        <p>Hello there, Sign in and start managing your EFS</p>
                    </div>
